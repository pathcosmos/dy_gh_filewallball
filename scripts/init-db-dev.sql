-- FileWallBall Development Database Initialization Script
-- This script creates the development database schema and initial data

-- Create database if not exists
CREATE DATABASE IF NOT EXISTS filewallball_dev CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- Use the database
USE filewallball_dev;
...
-- Insert development project for testing
INSERT IGNORE INTO projects (project_name, project_key) VALUES 
('dev-project', 'dev-project-key-67890'),
('test-project', 'test-project-key-11111');
