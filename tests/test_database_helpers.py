...
from app.utils.database_helpers import (
    DatabaseHelpers, generate_file_uuid, calculate_file_hash, format_file_size
)
...
class TestDatabaseHelpers:
    ...
    def test_search_files_basic(self, helpers, db_session):
        ...
        db_session.query.return_value.filter.return_value.order_by.return_value.offset.return_value.limit.return_value.all.return_value = mock_files
    ...
    def test_remove_tags_from_file_success(self, helpers, db_session):
        ...
        db_session.query.return_value.filter.return_value.first.side_effect = [mock_tag, mock_relation]
    ...
    def test_get_file_statistics(self, helpers, db_session):
        """파일 통계 조회 테스트"""
        # 모킹 설정
        db_session.query.return_value.filter.return_value.scalar.side_effect = [10, 1024000]  # 파일 수, 총 크기
    ...
    def test_get_upload_trends(self, helpers, db_session):
        ...
        db_session.query.return_value.filter.return_value.group_by.return_value.order_by.return_value.all.return_value = mock_result
