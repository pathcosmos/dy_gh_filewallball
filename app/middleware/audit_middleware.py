...
class AuditMiddleware(BaseHTTPMiddleware):
    ...
    async def _log_audit_event(self, **kwargs):
        ...
        try:
            ...
            # Assuming rbac_service is no longer needed or replaced by direct DB logging
            # If rbac_service was used for logging, it would be here.
            # For now, we'll just log directly to the database.
            ...
            audit_log = AuditLog(
                ...
                user_id=(
                    kwargs["current_user"].id if kwargs["current_user"] else None
