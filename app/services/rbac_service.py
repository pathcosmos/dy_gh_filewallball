...
from app.models.orm_models import AuditLog, FileInfo, User
...
class RBACService:
    ...
    def __init__(self):
        ...
        self.file_access_rules = {
            ...
            "delete": {"admin": "all", "moderator": "all", "user": "own_only"},
            "permanent_delete": {"admin": "all", "moderator": "none", "user": "none"},
        }
    ...
    def can_access_file(
        self, user: User, file_info: FileInfo, action: str
    ) -> Tuple[bool, str]:
    ...
    def get_user_files_query(
        self, db: Session, user: User, include_public: bool = True
    ):
