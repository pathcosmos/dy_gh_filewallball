...
class FileValidator:
    ...
    async def validate_file(self, file: UploadFile) -> Dict[str, any]:
        ...
        try:
            ...
            if not extension_validation['is_valid']:
                ...
                validation_result['file_info']['extension'] = extension_validation['extension']
                validation_result['file_info']['mime_type'] = extension_validation['mime_type']
            ...
            if not size_validation['is_valid']:
                ...
                validation_result['file_info']['file_size'] = size_validation['file_size']
    ...
    async def _validate_extension(self, file: UploadFile) -> Dict[str, any]:
        ...
        try:
            ...
            # 데이터베이스에서 확장자 정보 조회
            db_extension = self.db_session.query(FileExtension).filter(
    ...
    async def _validate_file_size(self, file: UploadFile) -> Dict[str, any]:
        ...
        try:
            ...
            max_file_size = self.db_helpers.get_system_setting('max_file_size', 104857600)  # 기본 100MB
        ...
        try:
            ...
            for pattern in dangerous_patterns:
                if pattern in filename:
                    result['is_valid'] = False
                    result['errors'].append(f"파일명에 위험한 문자가 포함되어 있습니다: {pattern}")
                    return result
    ...
    def get_allowed_extensions(self) -> List[str]:
        """허용된 파일 확장자 목록 반환"""
        try:
            extensions = self.db_session.query(FileExtension).filter(
    ...
    def get_file_size_limits(self) -> Dict[str, int]:
        ...
        try:
            # 시스템 전체 제한
            max_file_size = self.db_helpers.get_system_setting('max_file_size', 104857600)
            ...
            limits = {
                ...
                'by_extension': {ext.extension: ext.max_file_size for ext in extensions}
            }
