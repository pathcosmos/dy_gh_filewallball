...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_file_extensions_extension"),
        "file_extensions",
        ["extension"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_file_tags_tag_name"), "file_tags", ["tag_name"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_files_file_extension"), "files", ["file_extension"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_file_uploads_upload_session_id"),
        "file_uploads",
        ["upload_session_id"],
        unique=False,
    )
